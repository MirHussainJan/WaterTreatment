...
import SAction from "./ui/Action";
import { FaPlay } from "react-icons/fa";

export default function VideoSection() {
  const [click, setClick] = useState(false); // start hidden
      ...
      <section className="py-16 bg-[url(https://waterengineering.ae/wp-content/uploads/2024/09/vw_shape_bg_1.png)] bg-cover mx-auto">
        <div className="container mx-auto px-4 max-w-[1140px]">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-[#01008c] mb-6 md:w-[40%] mx-auto titles">
              ...
              <div className="w-full">
                <div className="aspect-video flex items-center justify-center">
                  <div className="bg-transparent p-7 flex rounded-full border border-zinc-300/40">
                    <button
                      onClick={() => setClick(true)} // ✅ open modal
                      className="w-25 h-25 bg-[#01008C] rounded-full flex items-center justify-center text-2xl text-white hover:bg-blue-800 cursor-pointer transition-all duration-300"
                    >
                      <FaPlay />
                    </button>
                  </div>

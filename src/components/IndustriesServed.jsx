    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto md:px-4">
        ...
        <div className="w-full md:w-[52%]">
              <div className="w-full rounded-2xl h-90  md:h-120 md:sticky top-30">
                <img src="/unnamed.jpg" className="w-full h-full rounded-2xl" alt="" />
              </div>
        </div>

...
export default function FrequentlyAskedQuestion({ faq }) {
  const [showUp, setShowUp] = useState(0);
  const defaultFaq = [
    {
      question: "What is a custom purification system?",
      answer:
        "A custom purification system is designed specifically to meet unique water quality needs. It utilizes advanced filtration methods to ensure clean water, making it suitable for various applications, including residential, industrial, and commercial use.",
    },
    {
      question: "How often should custom purification system maintenance?",
      answer:
        "Regular maintenance is essential for optimal performance. We recommend scheduling custom purification system maintenance at least once a year to ensure it operates efficiently, prevents potential issues, and extends the system's lifetime for reliable water purification.",
    },
    {
      question: "What does a custom purification system include?",
      answer:
        "Our custom purification system service includes installation, routine inspections, and thorough cleaning of components. Also, we provide performance testing to identify any issues and ensure your system consistently delivers clean, safe water customized to your needs.",
    },
  ];
  const questions = faq && faq.length > 0 ? faq : defaultFaq;
  return (
    <>

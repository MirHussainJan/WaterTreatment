...
export default function ActivatedCarbonFiltration() {
  ...
  return (
    <>
      <Header />
  <HeroSection title="Activated Carbon Filtration" description="Experience fresh, clean water with Innovators's advanced activated carbon filtration systems. Our technology removes contaminants, odors, and chemicals, delivering pure water for every use. Whether you need a filtration system for residential, commercial, or industrial applications, we deliver reliable solutions tailored to your needs. Enjoy the benefits of superior water quality and peace of mind with every drop." imgUrl="/Banner-01-1024x480.jpg" />

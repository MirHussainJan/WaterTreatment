...
export default function WaterPurificationTechnologies() {
  const steps = [
    {
      ...
      icon: "https://waterengineering.ae/wp-content/uploads/2024/09/Custom-Purification-Systems-01.png",
    },
    {
      ...
      icon: "https://waterengineering.ae/wp-content/uploads/2024/09/Custom-Purification-Systems-02.png",
    },
    {
      ...
      icon: "https://waterengineering.ae/wp-content/uploads/2024/09/Custom-Purification-Systems-03.png",
    },
    {
  ...
  return (
    < >
        <Header />
        <HeroSection title="Custom Purification Systems" description="Enhance your water quality with Water Engineering.ae, the trusted provider of custom water purification systems. Our customized solutions ensure clean, safe drinking water for homes and businesses. Whether you need custom purification systems for drinking water or industrial custom purification systems, we’ve got you covered. Experience the difference with our innovative technology and expert support. Reach us today to discuss how we can meet your unique purification needs!" imgUrl="../assets/Imgs/CPS.png" />
        <SecondSection title="Transform Your Water With Custom Purification Systems" desc="At Water Engineering.ae, we specialize in designing custom purification systems that meet your specific water needs. Our best custom purification systems for home provide safe and clean drinking water. With our expert team, we focus on custom purification system design that integrates seamlessly into your lifestyle. Whether for residential or industrial use, our custom-built water filtration solutions guarantee optimal performance and reliability. Enjoy peace of mind knowing your water is purified to the highest standards. Discover how our systems can transform your water quality by contacting us today!" />
        <ThirdSection text1={"Upgrade Your Water Standards with Custom Solutions"} dec1={"We offer innovative custom purification systems designed to meet various water quality needs. Our solutions are customized to optimize performance, ensuring you receive the cleanest water possible. With Water Engineering.ae, enjoy peace of mind knowing your system is reliable."} dec2={"Our custom filtration and purification systems include advanced technology, effectively removing impurities from water. We focus on enhancing water quality for both residential and industrial applications. Trust our expertise to deliver top-tier solutions that exceed your expectations."} dec3={"For specialized environments, our custom air purification systems are designed to improve air quality in any space. We utilize advanced technology to address unique filtration needs. Reach out to Water Engineering.ae today for personalized solutions that ensure clean air and water."}/>
        <FourthSection />
        <Clients />
